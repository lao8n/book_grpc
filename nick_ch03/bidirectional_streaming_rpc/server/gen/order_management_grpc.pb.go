...
func (c *orderManagementClient) ProcessOrders(ctx context.Context, opts ...grpc.CallOption) (OrderManagement_ProcessOrdersClient, error) {
	stream, err := c.cc.NewStream(ctx, &OrderManagement_ServiceDesc.Streams[0], "/bidirectional_streaming_rpc.OrderManagement/processOrders", opts...)
	if err != nil {
		return nil, err
	}
...
var OrderManagement_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bidirectional_streaming_rpc.OrderManagement",
